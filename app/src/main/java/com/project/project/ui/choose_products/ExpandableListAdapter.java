...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public Object getChild(int groupPosition, int childPosititon) {
        return this._listDataChild.get(this._listDataHeader.get(groupPosition).name)
                .get(childPosititon);
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        lblListHeader.setText(groupItem.name);

        ImageView imageView = convertView.findViewById(R.id.group_image);
        imageView.setImageDrawable(convertView.getResources().getDrawable(groupItem.image));
